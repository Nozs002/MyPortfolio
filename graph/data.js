window.graphNodes = [
  ...
  },
  {
    ...
    path: 'modules/admin/password-recovery/api.md',
    description: '',
  },
  {
    ...
    type: 'document',
    module: 'MOD-ADMIN-RECOVERY',
    path: 'modules/admin/password-recovery/flow.md',
    description: '',
  },
  {
    ...
    type: 'document',
    module: 'MOD-ADMIN-RECOVERY',
    path: 'modules/admin/password-recovery/overview.md',
    description: '',
  },
  {
    ...
    type: 'document',
    module: 'MOD-ADMIN-RECOVERY',
    path: 'modules/admin/password-recovery/requirements.md',
    description: '',
  },
  {
...
window.graphEdges = [
  ...
  {
    source: 'modules/admin/password-recovery/api.md',
    target: 'MOD-ADMIN-RECOVERY',
    relation: 'belongs_to',
    description: 'Module domain mapping',
  },
  {
    source: 'modules/admin/password-recovery/flow.md',
    target: 'MOD-ADMIN-RECOVERY',
    relation: 'belongs_to',
    description: 'Module domain mapping',
  },
  {
    source: 'modules/admin/password-recovery/overview.md',
    target: 'MOD-ADMIN-RECOVERY',
    relation: 'belongs_to',
    description: 'Module domain mapping',
  },
  {
    source: 'modules/admin/password-recovery/requirements.md',
    target: 'MOD-ADMIN-RECOVERY',
    relation: 'belongs_to',
    description: 'Module domain mapping',
  },
