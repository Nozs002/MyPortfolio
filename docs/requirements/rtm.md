...
| **BRULE-07**    | Chỉ Portfolio Owner mới có quyền chỉnh sửa dữ liệu.                            | PRD-1.4, PRD-3.1          | NextAuth Session check                                                                    | `src/middleware.ts`, `src/lib/auth-shield.ts`                              | `TEST-AUTH-SHIELD`       | **Đã hoàn thành**  |
...
| **BR-16**       | Cung cấp phản hồi trực quan (thành công/thất bại) cho các thao tác người dùng. | PRD-3.2                   | N/A                                                                                       | `src/components/Notification/*`, `src/lib/context/NotificationContext.tsx` | `TEST-TOAST-FEEDBACK`    | **Đã hoàn thành**  |
